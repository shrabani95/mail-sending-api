...
class EditContestGiveAway extends Component {
    fileObj = [];
    fileArray = [];
    albumArray = [];
    Files = [];
    ...
    componentDidMount()
    {
        //document.getElementById("upload_file").checked=this.props.data.File_Upload===1?true:false;
    }
    onchangeCheck=(e)=>{
    ...
    ModalOpen = () => {
        ...
        this.setState({
            ...
            question_1:this.props.data.Q1,
            question_2:this.props.data.Q2,
            question_3:this.props.data.Q3,
            question_4: this.props.data.Q4,
            File_Upload: this.props.data.File_Upload,
            File_upload_text: this.props.data.File_upload_text,
        ...
        if (typeof file !== 'undefined') {
            ...
            this.getBase64(file).then(
                data => {
                    //console.log(data);
                    this.setState({
                        audioData: data, hideVideoAudio: true,
                        videoFile: null,
                        videoData: 'NA',
    ...
    nextClick = (event) => {
        ...
        if (isValid) {
            ...
            let Api_url = process.env.REACT_APP_API_URL + 'admin/updateContest';
            ...
            formData.append('DA_Min_Amount', this.state.min_amt)
    ...
    validation = () => {
        ...
        if (this.state.DA_Title.length > 0 && this.state.DA_Description.length > 0)
            return true;
        else
            return false;
            ...
            <>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>
                            <p className="addnew-title">{"Giveaway"}</p>
                        </Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                ...
                <input type="number" name="DA_Price" onChange={this.handleChange} value={this.state.DA_Price} className="form-control" placeholder=" Price" />       
                                ...
                                <div className="col-md-12 concert-box">
                                    <div className="row">
                                        <div className="col-md-12">
                                            <label>Collect info from followers</label>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row concert-row">
                                        ...
                                        <div className="col-md-2 col-4 concert">
                                            ...
                                            <input type="checkbox" id="upload_file" checked={this.state.File_Upload===1?true:false} onChange={this.onchangeCheck} />
                                            <div class="slider round"></div>
                                             </label>
                                        </div>
                                    </div>
                                    <div className="row concert-row">
                                        ...
                                        <div className="col-md-8 col-4 concert">  
                                            <input type="text" className="form-control" name="File_upload_text" id="text_for_file_upload" value={this.state.File_upload_text} placeholder="Enter the Text for file upload" onChange={this.handleChange}/>
                                        </div>
                                    </div>
                                    <div className="row concert-row">
                                    ...
                                    <div className="row concert-row">
                                     ...
                                     <div className="row concert-row">
                                            ...
                                            <input type="text" className="form-control" id="enter_price"  placeholder="Enter Price" name="DA_Price" 
                                                    value={this.state.DA_Price} disabled={this.state.isPriceDisabled}     onChange={this.handlePrice}
                                                    onKeyPress={(event) => {
                             ...
                             <div className="row concert-row">
                                <div className="col-md-8 col-9">
                                    <label >
                                     ...
                                     <div className="col-md-2 col-12 concert"> 
                                            <label class="switch" for="price_enter">
                                            <input type="checkbox" id="price_enter" checked={this.state.allowCustomertoPay===1? true:false} onChange={this.onchangeCheckPrice} />
                                                <div class="slider round"></div>
                                            </label>
                                    </div>
                                    {
...
EditContestGiveAway.propTypes = {

};

export default EditContestGiveAway;
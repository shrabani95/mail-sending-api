              ...
              <div className="container">
                ...
                <div className="row">
                    <div className="col-md-12">
                      <div className="text">
                        <h4>User agreement between HELLOSTAR MEDIA PRIVATE LIMITED (Expy.bio) and CREATORS / USERS</h4>
                        ...
                        <h4>1. General Terms of Interaction and Subject of the User Agreemen</h4>
                        ...
                        <p>2.3. The Creator also has the right to reject a User's request if it is undesirable, contains offensive language, obscenities, calls to incite ethnic hatred or enmity, violations of laws, etc.</p>
                        ...
                        <h4>The Creator confirms that he / she has read and understood all the points of this User Agreement and accepts them unconditionally.</h4>
